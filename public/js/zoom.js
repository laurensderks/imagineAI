 ...
 * mouse wheel, or a two-finger pinch gesture on touch devices.
 *
...
(function (global) {
  ...
  class ZoomController {
    ...
    _applySize() {
      ...
      // Keep the canvas centred in the scrollable viewport after a resize.
    ...
    _onTouchStart(e) {
      if (e.touches.length === 2) {
        ...
        this._pinch = { startDist: this._touchDistance(e.touches), startZoom: this.zoom };
      }
    }
    ...
    _onTouchMove(e) {
      if (e.touches.length === 2 && this._pinch) {
        ...
        this.setZoom(this._pinch.startZoom * ratio);
      }
    }
